    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-playfair font-bold text-white mb-6">
              To create memorable, timeless <span className="gradient-text">experiences</span>
            </h2>
      ...
      <div className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-playfair font-bold text-white mb-6">
              Featured <span className="gradient-text">Creatives</span>
            </h2>
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
      ...
      <div className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Get started today as a Creator or a Member
          </p>
          <Link
            to="/signin"
      ...
      <div className="py-20 px-4 border-t border-white/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 mb-12">
            Download and stay connected on the go
          </p>

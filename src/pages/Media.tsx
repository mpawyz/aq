...
const categories = {
  ...
  contests: ['all', 'all-africa-votes', 'ughha', 'asfa'],
};
    ...
    <div className="min-h-screen pt-20 pb-12 px-4 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8 items-stretch md:items-center">
          <div className="relative flex-1 md:basis-4/5">
          ...
          {/* Music Display Mode Toggle + Filter on Mobile Row */}
          {activeTab === 'music' && (
            <div className="flex flex-wrap items-center gap-2 md:gap-3 md:flex-nowrap">
              <span className="hidden md:inline text-gray-300 text-sm font-medium whitespace-nowrap">Display</span>
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                    musicDisplayMode === 'video'
                      ? 'bg-gradient-to-r from-yellow-500 via-yellow-400 to-amber-500 text-white'
              ...
              {/* Filter and Results - full size on mobile when space allows */}
          ...
          {/* Filter and Results for non-music tabs */}
          {activeTab !== 'music' && (
